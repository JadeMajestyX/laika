...
@section('aside')
    ...
    <li class="nav-item mb-2"><a class="nav-link text-white bg-white bg-opacity-10 rounded active" href="{{ route('usuarios') }}"><i class="bi bi-people me-2"></i> Usuarios</a></li>
